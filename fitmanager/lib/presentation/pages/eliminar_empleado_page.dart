...
class _EliminarEmpleadoPageState extends State<EliminarEmpleadoPage> {
  List<Map<String, String>> empleados = [
    {'id': 'EMP-001', 'nombre': 'Ana Ramírez'},
    {'id': 'EMP-002', 'nombre': 'Luis Herrera'},
    {'id': 'EMP-003', 'nombre': 'Carlos Méndez'},
    {'id': 'EMP-004', 'nombre': 'María Velásquez'},
  ];
  ...
  void _confirmarEliminacion(Map<String, String> empleado) {
    showDialog(
      context: context,
      builder:
          (_) => AlertDialog(
            ...
            content: Text(
              '¿Desea eliminar a ${empleado['nombre']} (${empleado['id']})?',
              style: const TextStyle(color: Colors.white70),
            ),
            actions: [
              TextButton(
